    ...
    useEffect(() => {
      ...
      const fetchAlbumsAndArtistsFromTopTracks = async () => {
        try {
          ...
          const allArtists = res.data.items.flatMap((track) => track.artists);
          // Buat unique artists
            ...
            <>
              ...
              <div className="flex justify-between items-center w-full max-w-6xl mt-8 mb-6 px-4 md:px-0">
                ...
                <button
                  ...
                  className="px-3 py-2 bg-green-600 hover:bg-green-700 text-white rounded-xl shadow font-bold ml-2"
                  title="Install App"
                >
              ...
              <div className="w-full flex flex-col items-center">
                ...
                {trendingAlbums.length > 0 && (
                  <div className="mb-10 w-full max-w-6xl">
                    <h2 className="text-2xl font-semibold mt-4 mb-4 text-white drop-shadow">
                      🔥 Albums Sedang Tren
                    </h2>
